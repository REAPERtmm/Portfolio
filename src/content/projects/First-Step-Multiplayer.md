...
For this *College C++ project*, **in pair**, We learned how to implement the building bloc of a interconnected game that use **UDP protocol** to communicate. For this I used the *[WINAPI](https://learn.microsoft.com/fr-fr/windows/win32/api/winsock2/)* which provied the socket and basic function to send a UDP request.

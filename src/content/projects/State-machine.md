...
In this project I implemented a algorithme that I particularly love : Wave Function Collapse. It take as input a set of tile and rules to connect them. And output a grid with a random displacement of the tile that follow the rules. The principle is extremely simple but also very effective : at every instant of the algorithme, each cell in the grid contains the number of tile that can be at this place and respect all rules. 
The Algorithme say : 
